...
//   node --experimental-strip-types prototypes/relay-experiments/verify-gitdeploy.ts
...
try {
  ...
  const bind = await caller.git.bind({ repo: 'KlausFan/portless-sample', branch: 'main', buildNode: 'builder', deployNode: 'builder', name: APP, port: APP_PORT, confirm: true });
